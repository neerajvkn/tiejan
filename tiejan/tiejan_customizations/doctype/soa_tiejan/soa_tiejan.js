...
frappe.ui.form.on('SOA Tiejan', {
	...
	refresh: function(frm){
		if(!frm.doc.__islocal) {
			frm.add_custom_button('Send Emails',function(){
				frappe.call({
					method: "tiejan.tiejan_customizations.doctype.soa_tiejan.soa_tiejan.send_emails",
					args: {
			...
			frm.add_custom_button('Download',function(){
				var url = frappe.urllib.get_full_url(
					'/api/method/tiejan.tiejan_customizations.doctype.soa_tiejan.soa_tiejan.download_statements?'
	...
	fetch_customers: function(frm){
		if(frm.doc.collection_name){
			frappe.call({
				method: "tiejan.tiejan_customizations.doctype.soa_tiejan.soa_tiejan.fetch_customers",
				args: {
...
frappe.ui.form.on('Process Statement Of Accounts Customer', {
	customer: function(frm, cdt, cdn){
		...
		frappe.call({
			method: 'tiejan.tiejan_customizations.doctype.soa_tiejan.soa_tiejan.get_customer_emails',
			args: {
